...
import Paper from '@ma  terial-ui/core/Paper';
...
class ResponsiveDialog extends React.Component {
  ...
  handlePushOrder = (evt)=>{
    ...
    if(evt.keyCode == 13 && this.state.dish && this.state.selectedDish && this.state.quantity && this.state.itemPrice && this.state.selectedColor.code){
                ...
                <DialogContent className="table-dialogContent">
                  <DialogContentText>
                    ...
                    {this.state.dish != 'Buffet' ?
                      <div className="select-option">
                        {this.state.dish && this.state.selectedDish && this.state.quantity && this.state.itemPrice && this.state.selectedColor.code ? <Fab onClick={this.addOrder.bind(this)} size="medium" color="secondary" aria-label="Add">
                          <AddIcon />
                        </Fab> : null
                        }
                      </div> : null
                      ...
                      <Paper>
                        <Table>
                          <TableRow>
                            ...
                            <TableCell align="left"><Typography className='typo-heading-table' variant='BUTTON'><b>Qty</b></Typography></TableCell>
